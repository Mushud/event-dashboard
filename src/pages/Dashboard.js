...
import Content from "./DasboardContent";
  ...
  return (
    <div>
      <div class="hidden lg:block lg:absolute lg:inset-0" aria-hidden="true">
        <svg
          class="absolute z-index-100 top-0 left-1/2 transform translate-x-64 -translate-y-8"
          width="640"
          height="784"
          fill="none"
          viewBox="0 0 640 784"
      ...
      <nav
        class="relative max-w-7xl mx-auto flex py-5 items-center justify-between px-4 sm:px-6"
        aria-label="Global"
      >
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div class="mt-8 md:mt-0 md:order-1">
            <p class="text-center text-base text-white">
              &copy; {new Date().getFullYear()} Hyper, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer> */}
